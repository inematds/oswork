...
(function (window, document) {
  ...
  function buildSelectionPopover() {
    ...
    SWATCHES.forEach(function (c) {
      ...
      b.setAttribute('aria-label', c === 'doubt' ? "Mark as a question" : ("Highlight color: " + {"todas": "all", "yellow": "yellow", "green": "green", "blue": "blue", "pink": "pink", "doubt": "question"}[c]));
  ...
  function renderJourney(mountEl) {
    ...
    ['todas'].concat(SWATCHES).forEach(function (c) {
      var o = document.createElement('option'); o.value = c; o.textContent = {"todas": "all", "yellow": "yellow", "green": "green", "blue": "blue", "pink": "pink", "doubt": "question"}[c]; selColor.appendChild(o);
    });
  ...
  function importJSON(text, opts) {
    ...
    if (parsed.courseId && parsed.courseId !== S.courseId) {
      res.errors.push("This file belongs to another course or language."); return res;
    }
    ...
    if (fields.some(function (key) { return parsed[key] !== undefined && !record(parsed[key]); }) ||
      ...
      res.errors.push("Invalid data structure."); return res;
    }
